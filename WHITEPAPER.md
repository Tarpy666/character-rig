# CharacterRig — Whitepaper

**Fleet designation:** `character-rig` · Part of the Counted fleet.

## Abstract

Skeletal rig: bones, IK two-bone solver, blend trees, walk cycle parameters. This repository ships a self-contained, deterministic implementation:
